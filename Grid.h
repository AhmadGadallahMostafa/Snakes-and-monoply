...
public:
	...
	bool IsOverLapping(GameObject* newObj)const;//checks the cell to find over lapping functions

	void resetCurr(); //Gadallah:to rest the current player 
	...
	GameObject* getGameObject(CellPosition& pos);
